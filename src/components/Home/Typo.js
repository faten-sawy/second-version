...
const Typo = () =>{
    {/**py-[20px] px-[40.2px] */}
    return( 
        <div className="flex justify-center pr-[8.8vw] pl-[6.7vw]  relative bg-[#FAFAFA]  2xl:pb-[124px]">
            <div className=" w-full  flex flex-row max-md:flex-col justify-between " >
                <div className=" w-[50%] mr-4 max-md:w-full max-md:mt-8 ">
                    <Image src={laps} alt="right-side-img" className="h-[80%] w-full "/>
                </div>
                <div className=" w-[50%] ml-4 max-md:w-full 2xl:ml-[70px]">
