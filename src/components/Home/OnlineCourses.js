        ...
        <div className='mr-[8.8vw] ml-[6.7vw]'>
            <div className="flex justify-between my-10 max-[512px]:flex-col ">
                <div className="flex flex-col">
                    <h2 className='text-[#007394] lg:text-[16.4px] 2xl:text-[20px] font-[en-meduim]'>Live Attendance Course</h2>
                    <p className="text-[#142431] lg:text-[18.76px] font-[en-meduim] 2xl:text-[28px]">Browse all courses now</p>
                </div>
